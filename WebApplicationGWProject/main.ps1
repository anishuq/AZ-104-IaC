...
. "$PSScriptRoot\JumpServerInstanceHelper.ps1"
. "$PSScriptRoot\WebServerInstanceHelper.ps1"

# Define Resource Group Name
$ResourceGroupName = "WebApplicationGW-rg"
...
$SubnetName2 = "HelloSubnet"
$SubnetAddressPrefix2 = "10.0.1.0/24"

$SubnetName3 = "ByeSubnet"
...
-HelloSubnetName $SubnetName2 -HelloAddressPrefix $SubnetAddressPrefix2 `
-ByeSubnetName $SubnetName3 -ByeAddressPrefix $SubnetAddressPrefix3
...
New-AzVMCreation -Vmname $jumpboxVMName -VNetName $VNetName1 -SubnetName $SubnetName1 `
...
#At first inside HelloSubnet we will create 3 web servers in a loop inside the function.
New-AzWebServerCreation -AppName "Hello" -VNetName $VNetName1 -SubnetName $SubnetName2 `
-ResourceGroupName $ResourceGroupName -Location $Location1 `
-Image $Image -Credential $vmcred

#Now inside ByeSubnet we will create 3 web servers in a loop inside the function.
New-AzWebServerCreation -AppName "Bye" -VNetName $VNetName1 -SubnetName $SubnetName3 `
-ResourceGroupName $ResourceGroupName -Location $Location1 `
-Image $Image -Credential $vmcred